...
Mobile.tap(findTestObject('Object Repository/settings/android.widget.TextView - (1)'), 0)

Mobile.tap(findTestObject('Object Repository/settings/android.widget.TextView - Gallery'), 0)
